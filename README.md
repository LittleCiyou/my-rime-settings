...
* **Wanxiang Large Language Model:** Enabled `wanxiang-lts-zh-hans` grammar support for superior contextual awareness and sentence completion.
...
* **万象大模型注入：** 开启了 `wanxiang-lts-zh-hans` 语法支持，大幅提升长句输入的准确度与语境理解力。
...
* **Plugins:** AI-Rime (v3), Wanxiang-LTS
